...
Ya que la has recuperado. Vuelve a hacer clic en su interior. Aparecerán los puntos blancos que delimitan la región. Si haces clic en uno de ellos, verás que se convierte en un punto azul. Esto significa que lo puedes mover. Si lo arrastras, verás que la región se va modificando. Puedes modificar la forma de la región a tu antojo. Puedes moverlos, para hacer la región más grande o más pequeña, o incluso para cambiar su forma. Para lograrlo, debes tener la punta del cursor, que es un círuclo verde con un signo `+` en su interior, dentro de la región. Si no lo tienes, no podrás mover los puntos. Cuesta un poco al principio, pero es fácil acostumbrarse.
...
```{r segmentacion_15, echo=F, fig.cap="Modificar la forma de una región", message=FALSE, warning=FALSE, out.width='50%', fig.align="center"}
...
```{r segmentacion_16, echo=F, fig.cap="Modificar la forma de una región", message=FALSE, warning=FALSE, out.width='50%', fig.align="center"}
