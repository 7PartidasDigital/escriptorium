---
title: "Manual eScriptorium: Primeros pasos"
author:
...
```{r ppasos_logo, echo=F, fig.cap="", message=FALSE, warning=FALSE, out.width='20%', fig.align="center"}
...
```{r ppasos_00, echo=F, fig.cap="Filología Digital - eScriptorium - Universidad de Valladolid", message=FALSE, warning=FALSE, out.width='15%', fig.align="center"}
knitr::include_graphics("https://github.com/7PartidasDigital/escriptorium/blob/main/imagenes/UVa_FD_LOGO.png?raw=true")
```
