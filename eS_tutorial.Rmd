...
A continuación haz clic en `Images`. Aquí es el lugar por medio del cual subirías las imágenes al servidor. Si las tienes en `jpg`, `png` o `tiff` solo tienes que arrastras las desde la carpeta en que las tengas y soltarlas en la ventana, o hacer clic para navegar por el sistema de carpetas de tu ordenador hasta localizarlas.
...
Para descargarlo, haz clic en el botón `Download` que hay en la parte superior derecha de la página. Se descargará un archivo llamado `MULAS.pdf`.
