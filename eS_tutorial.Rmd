...
Si todo ha ido bien, aparecerá un mensaje que dice `Document created successfully` y verás el documento que acabas de crear en la lista de documentos del proyecto.
