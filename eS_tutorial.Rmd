...
Vas a subir un pdf (pulsa aquí para acceder a él)[https://github.com/7PartidasDigital/escriptorium/blob/main/incunable_01/MULAS.pdf]. Bájalo a tu ordenador, es más sencillo, y después lo subes a `eS`. Hac clic en `Images (PDF)` y se abrirá una ventana donde podrás seleccionar el archivo que quieres subir. Se abrirá una ventana del explorador de archivos de tu ordenador. Busca el archivo  que has descargado y selecciónalo. A continuación, haz clic en `Start importing`. 
